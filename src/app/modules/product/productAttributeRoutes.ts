...
router.post("/", isAuthenticated,ProductAttributeController.create);  // POST request to create attributes
...
router.delete("/:id",isAuthenticated,ProductAttributeController.delete); // DELETE request to delete attributes
