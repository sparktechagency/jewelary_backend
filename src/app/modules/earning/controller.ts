...
const EarningsController = {
  ...
  //             PaymentModel.aggregate([
  //               { $match: { paymentType: "manual", status: "Paid" } }, // ✅ Ensure status: "Paid"
  //               { $group: { _id: null, total: { $sum: "$amount" } } }
  //             ])
  //           ]);
      
  //           // Assign extracted totals (default to 0 if no data found)
  ...
  //               break;
  //             case "todayEarnings":
  //               filter = { status: "Paid", createdAt: { $gte: startOfToday } };
  //               break;
  //             case "pendingPayments":
  //               filter = { paymentStatus: { $ne: "Paid" } };
  //               break;
  //             case "manualPayments":
  //               filter = { paymentType: "manual", status: "Paid" }; // ✅ Ensure status: "Paid"
  //               break;
  //             default:
